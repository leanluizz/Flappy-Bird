...
CharArray[1].addEventListener("click", () =>{
    Bird.src = "assets/skin-flappy-yellow.png"
})
CharArray[2].addEventListener("click", () =>{
    Bird.src = "assets/flappy-skin-red.png"
})
CharArray[3].addEventListener("click", () =>{
    Bird.src = "assets/flappy-angrybird-red-removebg-preview.png"
})
CharArray[4].addEventListener("click", () =>{
    Bird.src = "assets/flappy-chicken-skin.png"
})
...
const ListMapArray = [
    ...
    document.querySelector(".bttns")
]
ListMapArray[0].addEventListener("click", () =>{
    wm.style.backgroundImage = "url(assets/img/sky-padrão.gif)"
})
ListMapArray[1].addEventListener("click", () =>{
    wm.style.backgroundImage = "url(assets/img/gif-night.gif)"
})
ListMapArray[2].addEventListener("click", () =>{
    wm.style.backgroundImage = "url(assets/img/sky-pirates.gif)"
})
ListMapArray[3].addEventListener("click", () =>{
    wm.style.backgroundImage = "url(assets/img/sky-city.gif)"
})
ListMapArray[4].addEventListener("click", () =>{
    wm.style.backgroundImage = "url(assets/img/sky-china.gif)"
})
...
document.querySelector(".skin").addEventListener("click",  () => { 
   ...
   ListMapArray[5].style.display = "none";
})
...
document.querySelector(".button-X-char").addEventListener("click", () => {
    ...
    ListMapArray[5].style.display = "block";
})
